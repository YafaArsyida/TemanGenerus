        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title fw-bold">
                    <i class="ri-add-circle-line me-1 text-success"></i> Tambah Kegiatan
                </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                            ...
                            <div class="border rounded-3 p-3 bg-light">
                                <div class="d-flex align-items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <a href="{{ $lokasi_default['peta'] }}" target="_blank" class="text-primary fs-13">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="url" class="form-control" wire:model.defer="peta" placeholder="https://maps.google.com/...">
