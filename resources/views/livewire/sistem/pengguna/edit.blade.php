                ...
                <form wire:submit.prevent="updatePengguna">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                <label for="ms_desa_id" class="form-label">Akses Pengguna</label>
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="edit_{{ $item->ms_desa_id }}"
                                        ...
                                        @if(in_array($item->ms_desa_id, $selectedDesa)) checked @endif
                                    >
                                ...
                                @error('ms_desa_id') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
